...
import { captureReviewSubmitted } from "@/lib/analytics";
      ...
      {reviewId ? (
        <div className="text-center">
          ...
          <p className="mt-2 text-sm leading-6 text-ink-muted">
            Review #{reviewId} is stored on Stellar and will appear in the public review feed.
          </p>
        ...
        <form onSubmit={submit}>
          ...
          <fieldset className="mt-6">
            ...
            <div className="mt-3 flex w-fit gap-1" onMouseLeave={() => setHoveredRating(0)}>
              {[1, 2, 3, 4, 5].map((value) => {
          ...
          <div className="mt-5">
            <div className="flex items-center justify-between gap-4">
              <label className="text-sm font-bold text-ink" htmlFor="review-message">
                Review message
              </label>
